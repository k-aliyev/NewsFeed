...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    @Override public void onCreate(SQLiteDatabase sqLiteDatabase) {
        try {
            ...
            sqLiteDatabase.execSQL(UserSourceTable.CREATE_TABLE_SQL);
    ...
    @Override public void onUpgrade(SQLiteDatabase sqLiteDatabase, int oldVersion, int newVersion) {
        try {
            sqLiteDatabase.execSQL(UserTable.DROP_TABLE_SQL);
            sqLiteDatabase.execSQL(UserSourceTable.DROP_TABLE_SQL);
        } catch (SQLException e) {
            e.printStackTrace();
        }
